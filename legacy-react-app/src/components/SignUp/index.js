...
const SignupPage = ({ isOpen, closePopup2, openPopup1, c_id }) => {
  ...
  const [showReferralErrMsg, setShowReferralErrMsg] = useState(false);
    ...
    axios
      ...
      .then((response) => {
        ...
        if (response.status === 201) {
          ...
          closePopup2();
          // resetForm();  // Reset form here after successful submission
        }
      })
      .catch((error) => {
          ...
          <div className="font-montserrat bg-gray-50 xs:top-0 lg:top-0 rounded-3xl cursor-pointer justify-center shadow-3xl items-center lg:mx-[200px] xl:mx-[400px] 2xl:[600px] lg:my-[20px] flex-nowrap overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            ...
            <Column className="sm:py-[50px]  sm:w-[100%] sm:h-[100%] lg:py-[10px] lg:w-[100%] lg:h-fit">
              ...
              <div className="mx-[60px] sm:hidden lg:block xl:block 2xl:block">
                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={referral_id}
                      onBlur={(e) => handleCheckReferralId(e.target.value)}
                  ...
                  <button
                    ...
                    disabled={!isChecked || isLoading} // Disable button if not checked or loading
                  >
                    Create an account
                  </button>

                  {/* Loading spinner will be rendered conditionally below the button */}
                  {isLoading && (
                ...
                <div className="social login space-y-4 mb-3">
                  {/* <button
                    type="submit"
                    class="w-full text-gray-600 bg-white items-center justify-center inline-flex border shadow-md
              ...
              <div className="sm:block lg:hidden mx-8">
                ...
                <button
                  type="submit"
                  class="mt-10 w-full text-gray-600 bg-white items-center justify-center inline-flex border shadow-lg 
