...
const LinkBtnSaveBlog = ({blogLink, modalVisible, itineraryId,creatorId,closePopup3}) => {
            ...
            <div className="model-content relative bg-white rounded-lg px-6 py-6 shadow-md space-y-3">
              ...
              <text className="text-gray-600 font-reg sm:text-[35px] lg:text-[14px] ">
                        {blogLink.length > 65
                          ...
                          : blogLink}</text>                <input type="hidden" id="input-url" value="Copied!" />
                <button
...
export default LinkBtnSaveBlog;
