    ...
    <>
      <header className="bg-white_A701 font-montserrat inline-flex items-center justify-center shadow-bs h-40 w-full visible lg:invisible lg:hidden">
        ...
        <div
          className={
            nav
              ? "fixed left-0 top-0 w-[800px] h-screen bg-gradient-to-b from-[#00A19A] to-[#2A3075] z-10 duration-200"
              : "hidden"
          }
        >
          <AiOutlineClose
            onClick={() => setNav(!nav)}
            size={50}
            className="absolute right-4 top-4 cursor-pointer text-[#FFFFFF]"
          />
              ...
              <>
                <ul className=" p-6 space-y-3 font-montserrat">
                  <li
                    ...
                    className="text-xl px-3 py-5 flex items-center"
                  >
                    <MdOutlineRocket
                      size={38}
                    ...
                    />
                    {/* <a href="#dashboard"> */}
                    <span class="mx-2 text-[35px] text-[#FFFFFF] font-medium">
                      Dashboard
                    </span>
                    {/* </a> */}
                  </li>
