...
//                 <ul class="py-2 text-sm text-left text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
//                   <li>
//                     <a href="/legacy/edit-creator" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit Profile</a>
//                   </li>
//                   <li>
//                     <a href="/legacy/influencer-creator" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">My Storefront</a>
//                   </li>
//                   <li>
      ...
      <Row className="row-1 w-full mt-2 mb-2 z-0 items-center justify-start p-2 gap-4">
        ...
        {isLoggedIn && (
         ...
         />
            ...
            <div>
              <button
                className="inline-flex border border-[#008D36] mx-2 p-2 gap-2 text-[#008D36] rounded-full items-center"
                id="dropdownNavbarLink"
                data-dropdown-toggle="dropdownNavbar2"
                onClick={toggleDropdown2}
              >
              ...
              >
                ...
                >
                  ...
                  <li>
                    <a
                      href="/legacy/influencer-creator"
                      class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                    >
                      My Storefront
                    </a>
