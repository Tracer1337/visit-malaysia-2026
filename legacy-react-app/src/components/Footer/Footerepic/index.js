        ...
        <div className=" sm:hidden xl:block 2xl:block">
            <div className="p-[50px] w-full font-montserrat bg-[#FFFFFF]">
                ...
                <div className="grid grid-cols-3 gap-5 w-[400px]">
                    ...
                    <div className="mt-[15px]">
                        <div>
                        <a href="https://www.facebook.com/people/Epictravel/61557253202076" target="_blank" rel="noopener noreferrer">
                        ...
                        <div>
                        <a href="https://www.youtube.com/@EpicVenturesLTD" target="_blank" rel="noopener noreferrer">
                        ...
                        <div>
                        <a href="https://x.com/epic_travelapp" target="_blank" rel="noopener noreferrer">
