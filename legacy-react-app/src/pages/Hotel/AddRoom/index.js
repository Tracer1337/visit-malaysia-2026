...
import { Column, Row, Text, Button, Input, Line } from "components";
    ...
    <>
      ...
      <Column className="bg-gray_100 pb-8 font-ptsans items-center justify-start w-[100%]">
          ...
          <Row className="gap-0.5 h-[60px] w-[80%] justify-evenly">
            <Column className="font-sans bg-gray_100 w-[15%] justify-end items-center">
              <Text
                ...
                className="common-pointer text-gray_501"
                variant="body4"
              >
                Basic Info
              </Text>
            ...
            <Column className="font-sans lg:text- bg-gray_200_ce  w-[14%] justify-end items-center">
              <Text
                ...
                className="common-pointer text-gray_702"
                variant="body4"
              >
                Layout & Pricing
              </Text>
        ...
        <Column className="justify-start gap-6 w-[80%]">
          ...
          <a
            href="/legacy/hs2"
            class="font-bold text-gray_600 dark:text-blue-500 hover:underline"
          >
            Go back to overview
          </a>
            ...
            <Column className="justify-start 2xl:my-[11px] 3xl:my-[13px]  xl:my-[15px] w-[100%]">
              ...
              <div className="w-[15%]">
                <Row>
                  ...
                  <Row className="py-2">
                    <BsFillPersonFill />
                    <Text className="font-bold text-[14px]">x6</Text>
                  </Row>
                </Row>
              </div>
            </Column>
            ...
            <Column className="justify-start rounded shadow pl-[15px] h-fit bg-white_A700 w-[76%]">
              <Column className="justify-start 2xl:my-[11px] 3xl:my-[13px]  xl:my-[15px] w-[100%]">
                ...
                <Column className="bg-gray-200 py-1">
                  <Text class="text-sm">
                    Tell us only about the existing beds in a room. Do not
                    include extra beds.
                  </Text>
                </Column>
                  ...
                  <div className="py-2 pt-6 w-[45%]">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option>
                          Extra-large double bed (Super-king size) / 181-210 cm
                          wide
                        </option>
                ...
                <button
                  value="Add another room"
                  checked={showhide === "Add another room"}
                  className="text-left hover:underline common-pointer w-[30%] text-blue-600"
                  onClick={handleshow}
                >
                  {" "}
                  Add another room
                      ...
                      <div className="py-2 pt-6 w-[45%]">
                        ...
                        <div>
                          ...
                          >
                            ...
                            <option>
                              Extra-large double bed (Super-king size) / 181-210
                              cm wide
                            </option>
                            <option>Bunk bed / Variable size</option>
                            <option>Sofa bed / Variable size</option>
            ...
            <Column className="justify-start 2xl:my-[11px] 3xl:my-[13px]  xl:my-[15px] w-[100%]">
              ...
              <Row>
                <div className="w-[50%] py-4">
                  <Text className="text-[14px]">Price for 1 person</Text>
                        ...
                        <Row className="flex space-x-4">
                          <div className="text-black flex items-center pl-4 rounded border border-gray-200 dark:border-gray-700 w-[30%] h-10">
                            <input
                              ...
                              name="userdetail"
                              value="yes1"
                              checked={showhide === "yes1"}
                              className="common-pointer w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                              onClick={handleshow}
                            />
                            <label class="common-pointer py-4 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">
                              Yes
                            </label>
                          </div>
                      ...
                      {showhide === "yes1" && (
                        <Column>
                          ...
                          <Text className="text-[14px] pt-5">
                            What is the minimum occupancy you are willing to
                ...
                <div className="w-[50%] py-4 ">
                  <Column className="w-[80%] bg-gray_400 my-5 pl-4 pt-3">
                    ...
                    <Text className="text-[12px] font-bold pb-5 pt-6">
                      After you have access to your Booking.com property
                      dashboard, we will ask you to double check your price
                      information before your property goes live on our website.
                    </Text>
                  </Column>
                </div>
              </Row>
