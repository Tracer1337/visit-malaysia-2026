  ...
  const updateBlogStatus = async (blogId, newStatus) => {
    try {
      const response = await axios.patch(
        `https://halaltravel.ai/ht/api/blog/updateStatus/${blogId}`,
        {
          status: newStatus,
        },
        {
    ...
    <>
      {showSuccessMessage && (
        <div className="success-message1">
          <div className="message-line">
            Blog deleted
            <button onClick={hideSuccess} className="close-button1">
              X
            </button>
          </div>
          <div className="message-line1">Blog successfully deleted</div>
        </div>
      )}
      ...
      {showUpdateSuccessMessage && (
        <div className="success-message1">
          ...
          <div className="message-line1">Status updated successfully</div>
        </div>
      )}
              ...
              <div class="flex items-center justify-between pb-4">
                ...
                <div class="relative">
                  ...
                  <input
                    type="text"
                    id="table-search"
                    class="sm:text-[20px] lg:text-[14px] block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div>
                  ...
                  >
                    <svg
                      class="w-3 h-3 sm:w-2.5 sm:h-2.5 text-gray-500 dark:text-gray-400 mr-2.5"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    ...
                    Last 30 days
                    <svg
                      class="w-3 h-3 sm:w-2.5 sm:h-2.5 ml-2.5 sm:ml-2"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 10 6"
                  ...
                  <div
                    id="dropdownRadio"
                    className={`z-10 font-normal w-48 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600 ${
                      nav ? "" : "hidden"
                    } absolute`}
                    ...
                    blogContent.map((record) => (
                      ...
                      >
                        ...
                        >
                          <Row>
                            <p
                              className="justify-center  w-fit sm:text-[22px] lg:text-[15px] text-black"
                              title={record.blogTitle}
                            >
                              {record.blogTitle.length > 50
                                ? record.blogTitle.substring(0, 50) + "..."
                                : record.blogTitle}
                            </p>
                          </Row>
                        </td>
                        <td className="text-center px-6 py-4 sm:text-[20px] lg:text-[14px] ">
                          Blog
                        </td>
                        <td className="item-center sm:text-[20px] lg:text-[14px] w-[15px]">
                          <select
                            ...
                            onChange={(e) =>
                              handleStatusChange(record.blogId, e.target.value)
                            }
                        ...
                        <td className="text-center px-4 sm:px-2 py-4 sm:py-6 lg:px-2 lg:py-2 sm:text-[20px] lg:text-[14px]">
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-4 sm:py-5 sm:px-5 lg:px-5 lg:py-2">
                            <AiFillEdit
                              ...
                              title="Edit Blog"
                              onClick={() =>
                                handleEditClick(record.blogId, userId)
                              }
                            />
                            <AiFillEdit
                              size={40}
                              className="cursor-pointer sm:block lg:hidden"
                              title="Edit Blog"
                              onClick={() =>
                                handleEditClick(record.blogId, userId)
                              }
                            ...
                            <AiFillDelete
                              size={20}
                              className="cursor-pointer text-[#c8102e] sm:hidden lg:block"
                              title="Delete Blog"
                              onClick={() => setShowConfirmation(record.blogId)}
                            />
                            <AiFillDelete
                              size={40}
                              className="cursor-pointer text-[#c8102e] sm:block lg:hidden"
                              title="Delete Blog"
                              onClick={() => setShowConfirmation(record.blogId)}
                            />
                          </div>
                ...
                <div className="justify-center items-center mt-5">
                  <div className="flex flex-row m-2 font-poppins common-pointer justify-center items-center">
                    ...
                    {currentPageBlog < totalPagesBlog - 1 && (
                      <span className="text-gray-500 mx-2 font-bold">
                        . . .
                      </span>
                    )}
                    <ButtonMp
          ...
          >
            ...
            <div className="p-4 item-center">
              ...
              <h5 className="text-center xs:text-[28px] lg:text-[18px] font-medium leading-normal text-gray-800">
                An error has occurred due to an authentication issue. Please log
                in again.
              </h5>
