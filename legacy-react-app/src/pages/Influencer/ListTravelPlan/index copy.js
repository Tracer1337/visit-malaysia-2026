      ...
      <div className="lg:h-[850px] md:h-[190vh] bg-[#F5F5F5]">
        <div className="bg-[#F5F5F5] flex flex-col font-montserrat lg:h-[fit] md:h-[fit]">
          ...
          {isLoadingg ? (
            ...
            <>
              <div className="">
                <div className="w-[100%] lg:h-[100vh] sm:h-[50vh]">
                  <img
                    className="w-full h-full object-cover brightness-75"
                    src={dataBlog.headerImage}
                  />
                </div>
                <div className="w-[90%] lg:h-[60vh] sm:h-[47vh] lg:top-[230px] sm:top-[0px] mx-[60px] absolute ">
                  <text className="absolute bottom-0 left-0 lg:text-[22px] sm:text-[48px] lg:font-medium sm:font-medium text-[#FFFFFF] ">
                    {dataBlog.title}
                  </text>
                </div>
              </div>
