...
const WebListTravelPlan = (page) => {
  ...
  useEffect(() => {
    setIsLoadingg(true);
    const apiUrl = `https://halaltravel.ai/ht/api/blog/srp-most-bookmark?pageNumber=${pageNumber}&pageSize=10`;
    ...
    <div className="w-full mb-8">
      ...
      <div className="flex flex-row gap-6 overflow-x-auto w-full scrollbar-hide">
        {results.map((result, index) => (
          ...
          key={index} className="bg-white flex-shrink-0 w-[300px] h-[360px] border shadow-lg rounded-lg hover:scale-105 duration-300">
