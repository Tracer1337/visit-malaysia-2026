...
const EditBlogPreview = () => {
	...
	const [coverImage, setCoverImage] = useState(localStorage.getItem('headerImagePath') || '');
	const [blogData, setBlogData] = useState({ title: '', blog: '', coverImageUrl: null});
			...
			<div className='lg:mx-72 xs:mx-5 xs:pt-[160px] lg:pt-[92px] mb-8'>
				...
				<div className='mt-8 border border-2 border-[] rounded-sm shadow p-10 px-20 py-10 h-[fit]'>
					<div id="previewContent" className='pt-4 py-2 w-[100%] text-justify'>
						{/* {coverImage && <img src={coverImage} alt="coverImage" style={{ width: '787px', height: '381px' }} />} */}
						
						<p style={{
							color: '#031DA8'
						}} className='lg:text-[40px] sm:text-[65px]'>{blogData.title}
						</p>
						<br></br>
						...
						<div className='sm:text-[30px] lg:text-[14px] styled-content' dangerouslySetInnerHTML={{ __html: blogData.blog }} />
