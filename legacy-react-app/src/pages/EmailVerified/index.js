              ...
              <section>
                <div className="card">
                  <div className="card-header flex flex-col justify-center items-center">
                    <FaCheckSquare className="sm:block lg:hidden" size={70} fill="#87B87F" />
                    <FaCheckSquare className="sm:hidden lg:block" size={30} fill="#87B87F" />
                    <text className="text-[35px] lg:text-[14px]">Your Email has been successfully verified</text>
                  </div>
        ...
        <>
          ...
          <div className="flex justify-center items-center h-screen">
            <div className="grid items-center">
              <section>
                <div className="card">
                  <div className="space-y-2 card-header flex flex-col justify-center items-center">
                    <CgCloseR className="md:block lg:hidden" size={70} fill="#87B87F" />
                    <CgCloseR className="md:hidden lg:block" size={30} fill="#87B87F" />
                    <text className="text-[35px] lg:text-[14px]">Your Email not successfully verified</text>
                    <text className="text-[35px] lg:text-[14px]">Reset password token is not valid or has expired. </text>
                    <text className="text-[35px] lg:text-[14px]">Please request a new token.</text>
                  </div>
                  <div className="card-footer mt-4">
                    <button
                      className="text-white text-[35px] lg:text-[14px] bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg py-2.5 px-3 w-full"
                      onClick={handleNavigate}>
