        ...
        <div className='flex flex-col font-montserrat mx-auto w-full h-auto'>
            ...
            <div className='xs:px-[50px] lg:px-[200px] xs:pt-[180px] lg:pt-[92px]' style={{ zIndex: 1 }}>
                <span className='justify-left'>
                    <img src='images/LogoEPICTRAVEL1.png' alt="Epic Travel Logo"></img>
                </span>
                <h2 className='lg:text-[24px] xs:text-[28px] leading-none tracking-tight pt-8'>
                    Privacy Policy
                </h2>
                <span className='italic lg:text-[15px] xs:text-[20px]'>Last updated: July 24, 2024</span>
                
                <div className="pt-[20px]">
                    <div className='space-y-8 text-justify text-black lg:text-[14px] xs:text-[22px]'>
                        <div>
                            <h5 className='lg:text-[16px] xs:text-[24px]'>Interpretation and Definitions</h5>
                            <h6 className='lg:text-[14px] xs:text-[20px]'>Interpretation</h6>
                            <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
                        </div>
                        <div>
                            <h6 className='lg:text-[14px] xs:text-[20px]'>Definitions</h6>
                            ...
                            <ul className='ml-5'>
                                ...
                                <li><strong>Company:</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Epic Ventures Ltd, Unit 2-8, Level 2, Labuan Times Square, Jalan Merdeka, 87000 Federal Territory of Labuan Malaysia.</li>
                                ...
                                <li><strong>Website:</strong> Refers to Epictravel, accessible from <a href="https://www.epictravel.ai" className='text-[#166fd4]'>https://www.epictravel.ai</a>.</li>
                        ...
                        <div>
                            <h5 className='lg:text-[16px] xs:text-[24px]'>Collecting and Using Your Personal Data</h5>
                            <h6 className='lg:text-[14px] xs:text-[20px]'>Types of Data Collected</h6>
                            <h6 className='lg:text-[14px] xs:text-[20px]'>Personal Data</h6>
                            ...
                            <h6 className='lg:text-[14px] xs:text-[22px]'>Usage Data</h6>
                        ...
                        <div>
                            <h5 className='lg:text-[14px] xs:text-[24px]'>Tracking Technologies and Cookies</h5>
                        ...
                        <div>
                            <h5 className='lg:text-[16px] xs:text-[24px]'>Use of Your Personal Data</h5>
                        ...
                        <div>
                            <h5 className='lg:text-[16px] xs:text-[24px]'>Disclosure of Your Personal Data</h5>
                        ...
                        <div>
                            <h5 className='lg:text-[16px] xs:text-[24px]'>Retention of Your Personal Data</h5>
                        ...
                        <div>
                            <h5 className='lg:text-[16px] xs:text-[24px]'>Transfer of Your Personal Data</h5>
                        ...
                        <div>
                            <h5 className='lg:text-[16px] xs:text-[24px]'>Delete Your Personal Data</h5>
                        ...
                        <div>
                            <h5 className='lg:text-[16px] xs:text-[24px]'>Disclosure of Your Personal Data</h5>
                            <h6 className='lg:text-[14px] xs:text-[20px]'>Business Transactions</h6>
                            <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
                            <h6 className='lg:text-[14px] xs:text-[20px]'>Law enforcement</h6>
                            <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
                            <h6 className='lg:text-[14px] xs:text-[20px]'>Other legal requirements</h6>
                        ...
                        <div>
                            <h5 className='lg:text-[16px] xs:text-[24px]'>Security of Your Personal Data</h5>
                            <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
                        </div>
                        <div>
                            <h5 className='lg:text-[16px] xs:text-[24px]'>Children's Privacy</h5>
                        ...
                        <div>
                            <h5 className='lg:text-[16px] xs:text-[24px]'>Links to Other Websites</h5>
                            <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
                            <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
                        </div>
                        <div>
                            <h5 className='lg:text-[16px] xs:text-[24px]'>Changes to this Privacy Policy</h5>
                            <p>We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page.</p>
                            <p>We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the "Last updated" date at the top of this Privacy Policy.</p>
                            <p>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>
                        </div>
                        <div>
                            <h5 className='lg:text-[16px] xs:text-[24px]'>Contact Us</h5>
                            <p>If you have any questions about this Privacy Policy, You can contact us:</p>
                            <p>By email: <a href="mailto:admin@epictravel.ai" className='text-[#166fd4]'>admin@epictravel.ai</a></p>
                        </div>
                    </div>
                </div>
