    ...
    >
      {loading ? (
        ...
        <div className="sm:bg-white bg-[#F5F5F5] w-full h-full sm:p-0">
          ...
          <div className="w-[300px] h-[200px] px-4 py-2.5 sm:mt-3 mt-[85px] mb-[15px] border-[0.5px] border-[#5c5c5f] rounded-sm flex justify-between items-center gap-4">
            ...
            <div className="w-full ml-3 grid gap-3">
              <LabledInput
          ...
          <div className="w-[300px] flex justify-between mt-1 items-center">
            <div>
...
ReactDOM.render(<EventDialogActvtNew />, document.getElementById("root"));
export default EventDialogActvtNew;
