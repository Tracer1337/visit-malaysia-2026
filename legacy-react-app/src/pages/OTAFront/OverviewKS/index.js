...
"Hang tight while we make sure your trip is top-notch"
 ...
 const data3 = useSelector((state) => state.data.data3);
  ...
  const data22 = [
    {
        day: 'Day 1',date:'5 September', 
        
        morningactivity: 'Visit ' ,
        morningplace:'Bukit Melawati',
        mcomment:', Visit the historical sites of Bukit Melawati, such as the Royal Mausoleum, the Sultan Alaeddin Mosque, and the lighthouse.',
        mimage:require('../../../assets/images/BM.jpg'),
        
        lunch:'Restoran Kampung Kuantan',
        
        
        afternoonactivity:'Visit ',
        afternoonplace:'Kuala Selangor Nature Park',
        acomment: ', Visit the Kuala Selangor Nature Park and explore the mangrove forest, watch the fireflies and take a boat ride.',
        aimage:require('../../../assets/images/np.jpg'),
        
        eveningplace:'Kuala Selangor Fireflies Park',
        eveningactivity:'Visit ',
        ecomment:', Visit the Kuala Selangor Fireflies Park and take a boat ride to watch the fireflies.',
        eimage:require('../../../assets/images/fireflies.jpg'),
...
<div className="justify-between flex bg-white shadow-lg p-4 w-full">
  <Row className="grid grid-row-2 grid-flow-col">
    <text className="font-montserrat ml-2 text-[50px] sm:text-[48px] md:text-[40px] xl:text-[40px]" style={{ color: '#45B9B4' }}>
      {receivedData.days} Day Trip To {receivedData.message}
    </text>
    {/* <Img
      src="images/edit.svg"
