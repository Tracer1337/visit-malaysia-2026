...
//import WebListTravelPLan from  '../Influencer/ListTravelPlan/webListTravelPLanrecent';
import WebListTravelPLanrecent from '../../Influencer/ListTravelPlan/webListTravelPLanrecent';
import WebListTravelPLanrecentbookmark from '../../Influencer/ListTravelPlan/webListTravelPLanbookmark';
  ...
           
        ...
        >
          <Img
            ...
            alt="rectangle120"
          />
          {/* <div id="planholiday" className="absolute md:gap-10 inset-x-[0] text-center items-center justify-start mx-auto md:top-[30%] md:p-2 xl:top-[25%] lg:w-[80%] sm:w-[90%]">
            <Text
              className="text-center font-bold xs:text-5xl lg:text-[30px] font-montserrat absolute inset-x-[0] sm:leading-relaxed lg:leading-loose mx-auto not-italic text-black_900 text-left tracking-wide"
            >
              <>
              Make Every Trip Epic!<div><text className="font-normal lg:text-[25px] p-0">Create, Discover, and Share Unforgettable Travel Experiences</text> </div>
              </>
            </Text>
          </div> */}
...
className="font-normal font-montserrat not-italic p-[0]   text-black placeholder:required text-slate_700 w-[100%]"
          ...
          <div className="absolute invisible lg:visible bg-white_A700/75 xl:top-[60%] 2xl:top-[55%] bottom-[20%] left-[16%] flex gap-[7px] items-center justify-start p-0.5 rounded-[5px] w-[68%] md:h-[15%] xl:h-[25%]">
            <div className="bg-black">
              <Text
                ...
                variant="h5"
              >
                Enter your destination and start planning your awesome
                adventure !
              </Text>
            </div>
      ...
      <div>
        <div className="p-[50px] w-full">
          ...
          <div className="pt-[50px] w-full flex justify-between mb-[20px]">
            <div>
          ...
          <WebListTravelPLanrecentbookmark/>
