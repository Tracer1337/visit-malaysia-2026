        ...
        <div className="sm:bg-white bg-[#F5F5F5] w-full h-full sm:p-0">
          ...
          <div className="w-full sm:flex hidden justify-between mb-[18px] pb-2">
            <h1 className="text-lg text-[#000000DE]">
              {event?.title ? "Edit Activity" : event?.location && !event?.title ? "Add Meal" :  "New Activity"}
            </h1>
          ...
          <div className="hidden justify-between items-center py-7 px-5 w-full absolute top-0 left-0 bg-white shadow-bs8 mobile-modal-header">
            <img
              ...
              onClick={closeModal}
            />
            <p className="text-base leading-5 font-medium text-black ">{event?.title ? "Edit Activity" : "New Activity"}</p>
          ...
          <div className="flex w-full">
            ...
            <div className="w-full ml-3 gap-3">
              <LabledInput
          ...
          <div className="mt-3 flex">
            ...
            <div>
              ...
              <label for="radio-1" class="text-xs text-[#000000]"> Everybody </label>
            </div>
            <div className="ml-3">
              <input id="radio-2" type="radio" value="" name="radio" class="w-4 h-4"/>
              <label for="radio-2" class="text-xs text-[#000000]"> Specific People </label>
            </div>
          </div>
