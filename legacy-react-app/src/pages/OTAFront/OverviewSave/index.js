...
const OverviewSave = () => {
    ...
    const [userItineraryOtherTransport, setUserItineraryOtherTransport] = useState([]);
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                setUserItineraryOtherTransport(data.itineraryDetails.userItineraryOtherTransport);
                ...
                setCoverImage("https://halaltravel.ai/hv/api/chatgpt/user/itinerary/coverimage//" + data.itineraryDetails.itineraryImage)
    ...
    const getTimePeriod = (timeStr) => {
        ...
        if (timeInMinutes >= parseTime("12:00 am") && timeInMinutes < parseTime("12:00 pm")) {
            return "morning";
        } else if (timeInMinutes >= parseTime("12:00 pm") && timeInMinutes < parseTime("6:00 pm")) {
            return "afternoon";
        } else {
            return "evening";
        }
    ...
    const groupAndMergeByDateAndPeriod = () => {
        ...
        const allTransport = [
            ...userItineraryFlight.map(transport => ({ ...transport, types: 'flight' })),
            ...userItineraryBus.map(transport => ({ ...transport, types: 'bus' })),
            ...userItineraryCarRental.map(transport => ({ ...transport, types: 'car rental' })),
            ...userItineraryOtherTransport.map(transport => ({ ...transport, types: 'other transport' })),
        ];
        ...
        sortedDates.forEach(date => {
            ...
            ['morning', 'afternoon', 'evening'].forEach(period => {
                sortedGroupedData[date][period].sort((a, b) => parseTime(a.time) - parseTime(b.time));
            });
        });
            ...
            <div className="lg:hidden lg:max-h-0 lg:overflow-hidden absolute visible lg:invisible lg:hidden bg-[#EAEBEF] flex flex-col items-center justify-start mx-[auto] w-[100%]">
                ...
                <div className="mt-[1px] bg-white  w-[100%]  ">
                    <div className=' mx-[30px] my-4'>
                        <text className='w-[100%] font-sans text-[#000000] text-[55px] font-bold leading-9	'>{title}</text>
                    </div>
                        ...
                        <div className='mx-[30px] '>
                            ...
                            <Row className="w-[100%] mt-[30px]">
                                ...
                                <div className=" bg-white w-[100%] h-[fit]">
                                    ...
                                    <div>
                                        <img class="object-cover object-center w-[100%] h-[35vh] brightness-75 " src={coverImage} alt="Rounded avatar" />
                                    </div>
                                    ...
                                    {Object.entries(groupedData).map(([date, data], index) => (
                                        <React.Fragment key={index}>
                                            ...
                                            <div className="flex items-center" id={`day-${data.day}`} key={data.day}>
                                                <span className="flex-grow-[0.03] h-px bg-gray-400"></span>
                                                <span className="px-4  font-sans text-[46px] font-semibold">{data.day} : {date}</span>
                                                        ...
                                                        <div key={idx}>
                                                                ...
                                                                <div class="w-[95%] flex mx-6">
                                                                    ...
                                                                    <div className='w-[100%] '>
                                                                        <text className='font-bold text-[#111111BF] text-[46px] font-sans'>
                                                                            {item.time} - {item.activity ? item.activity.charAt(0).toUpperCase() + item.activity.slice(1).replace(item.place || "", "") : ""}
                                                                            {' '}{item.place ?
                                                                                (item.place.length > 30 ? item.place.substring(0, 30) + "..." : item.place)
                                                                                : ""}
                                                                        </text>
                                                                        <br />
                                                                        <div className='my-3'>
                                                                        ...
                                                                        <text className='text-[#000000] text-[36px] font-sans'>
                                                                            {item.activity ? item.activity.replace(item.place || "", "") : ""}
                                                                            {' '}
                                                                        ...
                                                                        <div className='text-center w-[60%] mt-4'>
                                                                            {item.image ? (
                                                                                <>
                                                                                    <img class="object-cover object-center h-[16vh] brightness-75 bg-[#E0E0E0] w-[30vh]" src={getProcessedImageUrl(item.image)} alt="image" />
                                                                                    <text className='text-[#000000] text-[24px] font-sans'>Recommendation</text>
                                                                                    <br />
                                                                                    <a href={getProcessedImageUrl(item.image)} target="_blank" rel="noopener noreferrer" className='text-[#000000] text-[24px] font-sans underline'>
                                                                                        See Image
                                                                                    </a>
                                                                                </>
                                                                            ) : null}
                                                                ...
                                                                <div class="my-4 w-[100%] mx-6">
                                                                    <div className='w-[5%]'>
                                                                        <div className="bg-[#D2D2D2] w-20 h-20 flex items-center justify-center rounded-full">
                                                                            <Icon class="text-[#00A19A]" path={mdiBus} size={2.5} />
                                                                        </div>
                                                                    </div>
                                                                    <div className='w-[95%]'>
                                                                        <text className='font-bold text-[#111111BF] text-[46px] font-sans'>
                                                                            {item.time} - {item.type === 0 ? 'Departure' : 'Arrival'} - {item.terminalLocation.charAt(0).toUpperCase() + item.terminalLocation.slice(1)}
                                                                        </text>
                                                                        <br />
                                                                        <div className='my-3'>
                                                                            <text className='font-bold text-[#000000] text-[46px] font-sans'>
                                                            ...
                                                            {item.types === 'flight' && (
                                                                <div class="my-4 w-[100%] mx-6">
                                                                    <div className='w-[5%]'>
                                                                        <div className="bg-[#D2D2D2] w-20 h-20 flex items-center justify-center rounded-full">
                                                                            <Icon class="text-[#00A19A]" path={mdiAirplane} size={2.5} />
                                                                        </div>
                                                                    </div>
                                                                    <br></br>
                                                                    <div className='w-[100%]'>
                                                            ...
                                                            {item.types === 'car rental' && (
                                                                <div class="my-4 w-[100%] mx-6">
                                                                    <div className='w-[5%]'>
                                                                        <div className="bg-[#D2D2D2] w-20 h-20 flex items-center justify-center rounded-full">
                                                                            <Icon class="text-[#00A19A]" path={mdiTaxi} size={2.5} />
                                                                        </div>
                                                                    </div>
                                                                    <div className='w-[100%]'>
                                                                        <text className='font-bold text-[#111111BF] text-[46px] font-sans'>
                                                                            {item.time} - {item.type === 0 ? 'Pickup' : 'Drop-off'} - {item.location.charAt(0).toUpperCase() + item.location.slice(1)}
                                                                        </text>
                                                                        <br />
                                                                        <div className='my-3'>
                                                                            <text className='font-bold text-[#000000] text-[46px] font-sans'>
                                                            ...
                                                            {item.types === 'other transport' && (
                                                                <div class="my-4 w-[100%] mx-6">
                                                                    <div className='w-[5%]'>
                                                                        <div className="bg-[#D2D2D2] w-20 h-20 flex items-center justify-center rounded-full">
                                                                            <Icon class="text-[#00A19A]" path={mdiTrainCar} size={2.5} />
                                                                        </div>
                                                                    </div>
                                                                    <div className='w-[100%]'>
                                                                        <text className='font-bold text-[#111111BF] text-[46px] font-sans'>
                                                                            {item.time} - {item.type === 0 ? 'Departure' : 'Arrival'} - {item.location.charAt(0).toUpperCase() + item.location.slice(1)}
                                                                        </text>
                                                                        <br />
                                                                        <div className='my-3'>
                                                                            <text className='font-bold text-[#000000] text-[46px] font-sans'>
            ...
            <div className="absolute invisible lg:visible bg-gray-60 h-[fit] items-center justify-start mx-[auto] w-[100%] xs:pt-[160px] lg:pt-[92px]">
                ...
                <div className={`mt-[1px] bg-white w-full ${isVisible ? 'block' : 'hidden'}`}>
                    <div className=' mx-[70px] py-4'>
                        <text className='w-[100%] font-sans text-[#000000] text-[28px] font-semibold leading-9	'>{title}</text>
                    </div>
                            ...
                            <>
                                ...
                                <div className=" bg-white w-[64%] ml-[70px] mr-[0px] h-[fit] ">
                                    <Row className="">
                                        <Row className="w-[50%]">
                                        <div>
    <a href={`/influencer-creator/${creatorId}`} className='mx-6 my-4 flex cursor-pointer'>
        <img 
        ...
        <span className='ml-3 mt-1 font-bold text-[16px] font-sans'>
            {userName}
                                    ...
                                    {Object.entries(groupedData).map(([date, data], index) => (
                                        <React.Fragment key={index}>
                                            <div className="flex items-center mt-4" id={`day-${data.day}`} key={data.day}>
                                                <span className="flex-grow-[0.03] h-px bg-gray-400"></span>
                                                <span className="px-4 font-sans text-[18px] font-semibold">{data.day}: {date} </span>
                                                <span className="flex-grow h-px bg-gray-400"></span>
                                            </div>
                                                        ...
                                                        <div key={idx}>
                                                                    ...
                                                                    <div class=" w-[100%] flex px-6">
                                                                        ...
                                                                        <div className='w-[95%] pl-6'>
                                                                            <text className='font-bold text-[#111111BF] text-[18px] font-sans'>
                                                                                {item.time} -
                                                                                {' '}
                                                                                {item.activity ? item.activity.charAt(0).toUpperCase() + item.activity.slice(1).replace(item.place || "", "") : ""}
                                                                                {' '}
                                                                                {item.place || ""}
                                                                            </text>
                                                                            <br />
                                                                            <div className='my-3 flex'>
                                                                                ...
                                                                                <AddtoBtn2 setActivityId={handleSetActivityId} activityId={item.id} openPopup44={openPopup44} openPopup1={openPopup1} className="ml-3 " />
                                                                ...
                                                                <div class="w-[100%] flex px-6 ">
                                                                    <div className='w-[5%] '>
                                                                        <div className="bg-[#D2D2D2] w-10 h-10 flex items-center justify-center rounded-full">
                                                                            <Icon class="text-[#00A19A]" path={mdiBus} size={1} />
                                                                        </div>
                                                                    </div>
                                                                    <div className='w-[95%] pl-6 '>
                                                                        <text className='font-bold text-[#111111BF] text-[18px] font-sans'>
                                                                        ...
                                                                        <br />
                                                                        <div className='my-3 flex '>
                                                                            <text className='font-bold text-[#000000] text-[18px] font-sans mr-3'> {item.title}</text>
                                                                        </div>
                                                                        ...
                                                                        >
                                                                            {activeBusId === item.id ? 'Hide Bus Details' : 'Show Bus Details'} {/* Toggle text */}
                                                                        </text>
                                                                        ...
                                                                        {activeBusId === item.id && ( // Conditionally render details if the id matches the active one
                                                                            <div className='mt-3'>
                                                                                ...
                                                                                <br />
                                                                                <text className='text-[#000000] text-[16px] font-sans '>
                                                                                    Terminal Location: {item.terminalLocation || 'N/A'}{' '}
                                                                                </text>
                                                                                <br />
                                                                                <text className='text-[#000000] text-[16px] font-sans '>
                                                                                    Booked Through: {item.bookedThrough || 'N/A'}{' '}
                                                                                </text>
                                                                                <br />
                                                                                <text className='text-[#000000] text-[16px] font-sans '>
                                                                                    Confirmation No: {item.confirmationNo || 'N/A'}{' '}
                                                                                </text>
                                                                                <br />
                                                                                <text className='text-[#000000] text-[16px] font-sans '>
                                                                        ...
                                                                        <div className='text-center w-[20%] mt-4'>
                                                                            {item.image ? (
                                                                                <>
                                                                                    ...
                                                                                    <text className='text-[#000000] text-[14px] font-sans '>Recommendation</text>
                                                                                    <br />
                                                                                    <a href={getProcessedImageUrl(item.image)} // Make sure this is a full URL or a valid path
                                                                                        target="_blank"
                                                                                        rel="noopener noreferrer"
                                                            ...
                                                            {item.types === 'flight' && (
                                                                <div class="  w-[100%] flex px-6 ">
                                                                    <div className='w-[5%] '>
                                                                        <div className="bg-[#D2D2D2] w-10 h-10 flex items-center justify-center rounded-full">
                                                                            <Icon class="text-[#00A19A]" path={mdiAirplane} size={1} />
                                                                        </div>
                                                                    </div>
                                                                    <div className='w-[95%] pl-6 '>
                                                                        <text className='font-bold text-[#111111BF] text-[18px] font-sans'>
                                                                        ...
                                                                        <text
                                                                            className='common-pointer text-[#000000] text-[16px] font-sans underline '
                                                                            onClick={() => toggleDetailsFlight(item.id)} // Toggle on click, passing the flight id
                                                                        >
                                                                            {activeFlightId === item.id ? 'Hide Flight Details' : 'Show Flight Details'} {/* Toggle text */}
                                                                        </text>
                                                            ...
                                                            {item.types === 'car rental' && (
                                                                <div class="w-[100%] flex px-6 ">
                                                                    <div className='w-[5%] '>
                                                                        <div className="bg-[#D2D2D2] w-10 h-10 flex items-center justify-center rounded-full">
                                                                            <Icon class="text-[#00A19A]" path={mdiTaxi} size={1} />
                                                                        </div>
                                                                    </div>
                                                                    <div className='w-[95%] pl-6 '>
                                                                        <text className='font-bold text-[#111111BF] text-[18px] font-sans'>
                                                                        ...
                                                                        >
                                                                            {activeCarId === item.id ? 'Hide Car Rental Details' : 'Show Car Rental Details'} {/* Toggle text */}
                                                                        </text>
                                                            ...
                                                            {item.types === 'other transport' && (
                                                                <div class="w-[100%] flex px-6 ">
                                                                    <div className='w-[5%] '>
                                                                        <div className="bg-[#D2D2D2] w-10 h-10 flex items-center justify-center rounded-full">
                                                                            <Icon class="text-[#00A19A]" path={mdiTrainCar} size={1} /> {/* You can choose a more relevant icon */}
                                                                        </div>
                                                                    </div>
                                                                    <div className='w-[95%] pl-6 '>
                                                                        <text className='font-bold text-[#111111BF] text-[18px] font-sans'>
                                                                        ...
                                                                        <text
                                                                            className='common-pointer text-[#000000] text-[16px] font-sans underline '
                                                                            onClick={() => toggleDetailsOther(item.id)} // Toggle on click, passing the id for "other" type
                                                                        >
                                                                            {activeOtherId === item.id ? 'Hide Other Transport Details' : 'Show Other Transport Details'} {/* Toggle text */}
                                                                        </text>
                                ...
                                <div className="  w-[25%] text-[#1F1F1F] h-[fit] fixed right-[70px] "  >
                                    <div className='bg-white px-8  grid grid-cols-1 divide-y divide-dashed font-sans' >
                                        ...
                                        <div style={{ maxHeight: data.length > 7 ? '250px' : 'auto', overflowY: data.length > 7 ? 'scroll' : 'visible' }}>
