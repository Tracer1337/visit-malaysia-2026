          ...
          <div className="bg-[#EAEBEF] flex flex-col font-ptsans items-center justify-start mx-auto w-full">
            ...
            <div className="justify-between flex items-center bg-white shadow-lg p-4 w-full">
              ...
              <div className="btnSave">
                <button class="font-montserrat text-[30px] fixed right-1/2 bottom-14 left-1/2 bg-[#00a19a] text-white_A700 text-xs flex items-center justify-center min-w-[100px] h-[80px] w-[300px] font-medium rounded-full shadow-md"
                  style={{
                    position: "fixed",
                    bottom: "50px",
                    left: "50%",
                          ...
                          <div className="flex items-center justify-center">
                            ...
                            > */}
                                        {item.morningactivity && item.morningactivity.replace(item.morningplace, "")} <text className='text-[#008009] underline'>
                                          <Link
                                            to={{
                                              pathname: `/LocationByItinerary/blog/display/${userId}/${item.morningplace}/${itineraryId}`,
                                              state: { itineraryId }
                                              // Pass itineraryId as state
                                            }}
                                            // href={`https://www.viator.com/searchResults/all?pid=P00094549&mcid=42383&medium=link&text=${item.morningplace}, ${receivedData.message}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                              ...
                              rel="noopener noreferrer"
                            > */}
                                        {item.afternoonactivity && item.afternoonactivity.replace(item.afternoonplace, "")} <text className='text-[#008009] underline'>
                                          <Link
                                            to={{
                                              pathname: `/LocationByItinerary/blog/display/${userId}/${item.afternoonplace}/${itineraryId}`,
                                              state: { itineraryId }
                                              // Pass itineraryId as state
                                            }}
                            ...
                            > */}
                                        ...
                                        <text className='text-[#008009] underline'>
                                          <Link
                                            to={{
                                              pathname: `/LocationByItinerary/blog/display/${userId}/${item.eveningplace}/${itineraryId}`,
                                              state: { itineraryId }
                                              // Pass itineraryId as state
                                            }}
                            ...
                            <div className="w-full">
                              ...
                              <div style={{ marginLeft: 10 }} className=" mt-0   w-full md:w-[700px] flex flex-col items-start">
                                ...
                                {(() => {
                                  ...
                                  const updatedDate1 = new Date(currentDate.getTime());
                                  updatedDate.setDate(updatedDate.getDate() + item.day - 1);
                                  // Calculate the next day for formattedDate3
                                  const updatedDate3 = new Date(currentDate.getTime());
                                  updatedDate3.setDate(updatedDate3.getDate() + item.day);
                                  ...
                                  const year3 = updatedDate3.getFullYear();
                                  const month3 = String(updatedDate3.getMonth() + 1).padStart(2, '0');
                                  const day3 = String(updatedDate3.getDate()).padStart(2, '0');
