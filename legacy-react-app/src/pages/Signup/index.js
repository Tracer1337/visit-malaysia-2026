      ...
      .catch((error) => {
        ...
        if (error.response) {
          ...
          if (error.response.status === 400) {
            ...
            if (
              error.response.data.message === "Error: email address is already taken"
            ) {
              // Show error message for existing email address
            ...
            if (firstNameError && firstNameError.validationError === "Field is required") {
            ...
            if (lastNameError && lastNameError.validationError === "Field is required") {
            ...
            if (passwordError && passwordError.validationError === "Field is required") {
            ...
            if (genderError && genderError.validationError === "Field is required") {
      ...
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto  lg:py-0">
        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-xl h-fit xl:p-0 dark:bg-gray-800 dark:border-gray-700">
         <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          <h1 className="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">                   Create your account
            </h1>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setFirstName(e.target.value)}
            />
            {errors.firstName && <div className="text-[#e63946]" >{errors.firstName}</div>}
          ...
          <div>
            ...
            />
            {errors.lastName && <div className="text-[#e63946]">{errors.lastName}</div>}
          </div>
          <div>
            ...
            />
            {errors.password && <div className="text-[#e63946]">{errors.password}</div>}
          </div>
          <div>
            ...
            />
            {errors.confirmPassword && <div className="text-[#e63946]">{errors.confirmPassword}</div>}
          </div>
          <div>
            ...
            />
            {errors.email && <div className="text-[#e63946]">{errors.email}</div>}
          </div>
          <div>
            ...
            <PhoneInput
              ...
              onChange={setValue}/>
            {errors.phoneNumber && <div className="text-[#e63946]">{errors.phoneNumber}</div>}
          </div>
          <div>
            <label htmlFor="dtOfBirth" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date of Birth</label>
            <input
              type="date"
              name="dtOfBirth"
              id="dtOfBirth"
            ...
            />
            {errors.dtOfBirth && <div className="text-[#e63946]">{errors.dtOfBirth}</div>}
          </div>
          <div>
            <label htmlFor="gender" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Gender</label>
            <select type="dropdown" name="gender" id="gender" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required=""
              value={gender} // Bind the 'gender' state to the value attribute
              onChange={(e) => setGender(e.target.value)} // Update 'gender' state on change
              >
            ...
            {errors.gender && <div className="text-[#e63946]">{errors.gender}</div>}
          </div>
          ...
          {/* Rest of your form fields */}
                 <div className="flex items-start mb-4">
                       ...
                       <div className="ml-3 text-sm">
                        <label for="terms" className="font-light text-gray-500 dark:text-gray-300">I accept the <a class="font-medium text-blue-600 hover:underline dark:text-primary-500" href="#">Terms and Conditions</a></label>
                     </div>
                   </div>
                   <button 
                   type="submit" 
